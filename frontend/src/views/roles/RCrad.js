  ...
  return (
    <CRow  className='d-flex justify-content-space-between px-2 align-items-center'>
      <CCol xs={12} md={3}  className='d-flex  align-items-center hCol'>
        ...
        <div className='mx-1'>
          <span className='d-block text-black'>{data.name}</span>
        </div>
     ...
     <CCol xs={12} md={2} className='hCol'>
      ...
      <CCol xs={12} md={2} className='hCol'>
         <Dropdown appearance="default" size='sm' title={data.status}>
      ...
      <CIcon icon={cilTrash}  />
      <CIcon icon={cilPen}  className='mx-3'  onClick={()=>{navigate('/Forklifts/save')}}/>
